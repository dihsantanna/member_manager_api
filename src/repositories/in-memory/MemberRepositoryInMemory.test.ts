...
describe('Testando MemberRepositoryInMemory', () => {
  ...
  describe('Método findById', () => {
    ...
    it('Deve retornar null se não encontrar um membro pelo id.', async () => {
      const memberRepositoryInMemory = new MemberRepositoryInMemory();
  ...
  describe('Método findAll', () => {
    ...
    it('Deve retornar um array vazio se não encontrar nenhum membro.', async () => {
      const memberRepositoryInMemory = new MemberRepositoryInMemory();
      const membersFound = await memberRepositoryInMemory.findAll();

      expect(membersFound).toBeInstanceOf(Array);
      expect(membersFound).toHaveLength(0);
    });
  });

  describe('Método findMemberMinistry', () => {
    ...
    it('Deve retornar null caso id de membro não exista', async () => {
      const memberRepositoryInMemory = new MemberRepositoryInMemory();
  ...
  describe('Método findMemberOccupation', () => {
  ...
  describe('Método updateMemberInMinistry', () => {
    ...
    it('Deve retornar null caso membro não exista', async () => {
      const memberRepositoryInMemory = new MemberRepositoryInMemory();
  ...
  describe('Método updateMemberInOccupation', () => {
